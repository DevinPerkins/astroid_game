...
class Asteroid(CircleShape):
    ...
    def split(self):
        ...
        if self.radius <= ASTEROID_MIN_RADIUS:
            ...
            new_smaller_radius = self.radius - ASTEROID_MIN_RADIUS

            new_asteroid_1 = Asteroid(self.position.x, self.position.y, new_smaller_radius)
            new_asteroid_2 = Asteroid(self.position.x, self.position.y, new_smaller_radius)
